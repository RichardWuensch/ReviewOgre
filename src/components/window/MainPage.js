...
function MainPage () {
  return (
    <div className={'main-page'}>
      ...
      <h2 className={'title-subheadline'}>
        Sort your review peers in groups for better Technical Reviews!
      </h2>
      <span className={'title-subheadline'} style={{ fontSize: 12 }}>
      ...
      <div className={'participant-slots-container'}>
        ...
        <div className={'participantWindow'}>
          ...
          <div className={'participant-button-container'}>
            ...
            <div
              className={'button-container-green-participants'}
              style={{ width: 100 }}
            >
          ...
          <div className={'participant-list-container'}></div>
        </div>
        {/* end */}
        {/* replace with component */}
        <div className={'slotsWindow'}>
          ...
          <div className={'slots-list-container'}></div>
        </div>
        {/* end */}
      </div>
      <div className={'setup-start-container'}>
        ...
        {/* end */}
        <div className={'button-start'} onClick={runAlgorithm}>
          <img
            src={start}
            alt={'startCalculationsIcon'}
            height={20}
            width={20}
          />
