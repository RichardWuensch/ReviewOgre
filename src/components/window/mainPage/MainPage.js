...
function MainPage () {
  ...
  const [overwriteExistingDataEvent, setOverwriteExistingDataEvent] =
    React.useState(null);
  ...
  return (
    <div className={'main-page'} onMouseMove={handleMouseMove}>
      ...
      <h2
        className={'title-subheadline'}
        style={{ fontWeight: 100, fontSize: '2.5em' }}
      >
        Sort your review peers in groups for better Technical Reviews!
      </h2>
      <span className={'title-subheadline'} style={{ fontWeight: 100 }}>
        Visit the <a href="url">HowToGuide</a> to learn more about this platform
      </span>
      <Row className={'button-group'}>
        <Col xs={8} md={4} className="mb-3 mb-md-0">
          ...
          >
            <Button
              ...
              onMouseEnter={() => {
                setPopoverText('Import Participants');
                handleMouseEnter(0);
              }}
          ...
          <input
            ...
            style={{ display: 'none' }}
            onChange={() => {
              importDataCheck(event);
              setImportDataWithSlots(false);
            }}
            accept="text/csv"
          />
        </Col>
        <Col xs={8} md={4} className="mb-3 mb-md-0">
          ...
          >
            <Button
              ...
              onMouseEnter={() => {
                setPopoverText('Load Configuration');
                handleMouseEnter(1);
              }}
        ...
        <Col xs={8} md={4} className="mb-3 mb-md-0">
          ...
          >
            <Button
              variant={'light'}
              className="button-container-white"
              onClick={saveConfiguration}
              onMouseEnter={() => {
                setPopoverText('Save Configuration');
                handleMouseEnter(2);
              }}
              ...
              <div className={'start-button-container'}>
                ...
                >
                  <Button
                    ...
                    onMouseEnter={() => {
                      setPopoverText('Compute Assignments');
                      handleMouseEnter(4);
                    }}
